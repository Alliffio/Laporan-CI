      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm justify-content-between mb-4">
            ...
            <br>
            <a href="<?php echo site_url('dashboard/cetak_laporan') ?>" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm"><i class="fas fa-file fa-sm text-white-50"></i> Generate PDF</a>
            <a href="<?php echo site_url('dashboard/excel_laporan') ?>" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm"><i class="fas fa-file fa-sm text-white-50"></i> Generate Excel</a>
          </div>
