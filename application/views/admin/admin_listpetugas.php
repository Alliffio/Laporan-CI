...
<head>
  ...
  <title>List Petugas | Admin</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm justify-content-between mb-4">
            <center><h1 class="h4 mb-0 text-gray-800">DATA PETUGAS / ADMIN</h1></center>
            <br>
            
            <!-- buat export pdf dan excel -->
            <a href="<?php echo site_url('dashboard/cetak')?>" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm"><i class="fas fa-file fa-sm text-50"></i> Generate PDF</a>
            
            <a href="<?php echo site_url('dashboard/excel_petugas')?>" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm"><i class="fas fa-file fa-sm text-50"></i> Generate Excel</a>
          ...
          <!-- buat munculin tabel data petugas -->
          <div id="view" style="margin: 10px 20px;">
              <?php $this->load->view('admin/view_petugas', array('admin'=>$admin)); // Load file view.php dan kirim data siswanya ?>
          </div>
        ...
        <div id="pesan-error" class="alert alert-danger"></div>
            <form>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="alamat" name="address" rows="5"></textarea>
                </div>
                <div class="form-group">
                    <label for="exampleFormControlInput1">Level</label>
                    <select class="custom-select" name="level" id="role">
