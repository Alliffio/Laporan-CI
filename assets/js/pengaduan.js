...
$(document).ready(function(){
	$('#loading-ubah, #pesan-sukses, #pesan-error').hide()
 ...
 //    var username = tr.find('.username-value').val() 
 //    var password = tr.find('.password-value').val() 
 //    var telp = tr.find('.telepon-value').val() 
 //    var alamat = tr.find('.alamat-value').val() 
 //    var level = tr.find('.role-value').val()
 //    $('#nik').val(nik) 
 //    $('#nama').val(nama) 
 ...
 //  })
	...
	$('#btn-simpan').click(function(){
		$.ajax({
			url: base_url + 'dashboard/simpan_laporan',
			type: 'POST',
			data: $("form").serialize(),
			dataType: 'json',
	...
	//     $.ajax({
	//       url: base_url + 'dashboard/ubah_petugas/' + id, // URL tujuan
 ...
 //    $.ajax({
 //      url: base_url + 'dashboard/hapus_petugas/' + id, // URL tujuan
